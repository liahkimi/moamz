...
class NoticeMapperTest {
    ...
    void insertNoticePost() {
        ...
        noticeMapper.insertNotice(adminNoticeWriteDTO);  // 공지사항 테이블에도 데이터 삽입

        // when: 작성된 공지사항 글 조회
        Optional<AdminNoticeDetailDTO> result = noticeMapper.selectNoticeById(adminNoticeWriteDTO.getFgPostId());
