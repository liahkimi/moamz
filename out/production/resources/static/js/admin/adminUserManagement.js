...
function showUserTable() {
    ...
    document.getElementById('seller-table-container').style.display = 'none';
    document.getElementById('seller-management-btn').classList.remove('active-btn');
    document.getElementById('user-management-btn').classList.add('active-btn');
}

function showSellerTable() {
    document.getElementById('user-table-container').style.display = 'none';
    document.getElementById('seller-table-container').style.display = 'block';
    document.getElementById('user-management-btn').classList.remove('active-btn');
    document.getElementById('seller-management-btn').classList.add('active-btn');
}
